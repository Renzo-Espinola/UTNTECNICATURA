class MiClase:
    ...
    @classmethod
    def metodo_clase(cls):  # cls es una referencia a la clase en si misma
...
MiClase.metodo_clase()  # No hace falta pasarle ningun parametro se genera automaticamente
